...
import BasicInfo from '~/components/detail/server/BasicInfo'
import ServiceItems from '~/components/detail/server/ServiceItems'
import ServiceInfo from '~/components/detail/server/ServiceInfo'
import Planners from '~/components/detail/TcPlanners'
import RecommendScProduct from '~/components/detail/server/RecommendScProduct'
