...
import Banner from '@/components/myDemandCard/companyRegister/header'
...
export default {
  ...
  mounted() {
    ...
    console.log('state.city.currentCity', this.$store.state.city.currentCity)
  },
  // mounted() {
  //   // 数据回显
  ...
  methods: {
    // 获取地区
    onCity(val) {
      if (!this.cityVal.code) this.cityVal = this.currentCity
