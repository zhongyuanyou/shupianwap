  ...
  <div class="container">
    <div class="container-advice">
      ...
      <div class="middle-title">
        <div class="title">“先享后付”尽在薯片平台</div>
      </div>

      <div class="advice-box">
        <div class="advice-content">
          <div class="advice-lf"></div>
          <div class="advice-rt">
            <div class="rt-top"></div>
            <div class="rt-bottom"></div>
          </div>
        </div>
      </div>
      <!-- E title -->
  ...
  .container-advice {
    ...
    .server-pay {
      ...
      .server-img {
        width: 108px;
        height: 125px;
        box-shadow: 13px 22px 35px 0px rgba(145, 0, 46, 0.75);
      }
      .pay {
        width: 260px;
        height: 72px;
    ...
    .middle-title {
      ...
      .title {
        ...
        font-weight: 500;
        color: #ffffff;
        text-shadow: 0px 3px 3px rgba(227, 48, 0, 0.7);
        padding: 18px 0;
        text-align: center;
        line-height: 28px;
      }
    ...
    .advice-box {
      ...
      .advice-content {
        ...
        .advice-lf {
          width: 327px;
          height: 298px;
          background: linear-gradient(0deg, #fee8e4, #ffffff);
          border-radius: 12px;
          position: relative;
          .law-consult {
            width: 136px;
        ...
        .advice-rt {
          ...
          .rt-top {
            width: 327px;
            height: 140px;
            background: linear-gradient(0deg, #fef6df, #ffffff);
            border-radius: 12px;
          }
          .rt-bottom {
            width: 327px;
