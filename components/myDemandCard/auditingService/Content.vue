...
<script>
import RevenueRadio from '~/components/myDemandCard/auditingService/RevenueRadio'
import Dropdown from '~/components/myDemandCard/auditingService/Dropdown'
import FixedButtom from '~/components/myDemandCard/auditingService/FixedButtom'
export default {
  name: 'Content',
  components: {
    RevenueRadio,
