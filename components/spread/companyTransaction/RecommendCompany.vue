<template>
  <div class="my-component">
    ...
    <!--            </ul>-->
    <!--          </div>-->
    <!--          &lt;!&ndash; E 推荐内容滚动区 &ndash;&gt;-->
    <!--          &lt;!&ndash; S 推荐商品列表 &ndash;&gt;-->
    ...
    <!--            </div>-->
    <!--          </div>-->
    <!--          &lt;!&ndash; E 推荐商品列表 &ndash;&gt;-->
    <!--        </div>-->
    <!--      </sp-swipe-item>-->
    <!--    </sp-swipe>-->
    <!--    <Loading-down-->
    <!--      v-if="tabBtn.length"-->
    <!--      :loading="loading && !tabBtn[currentItem].noMore"-->
    <!--      :no-data="tabBtn[currentItem].noMore"-->
    <!--    />-->
  </div>
</template>
...
export default {
  ...
  async created() {
    // if (process.client) {
    //   this.findRecomList(this.currentItem)
