      ...
      <div class="form-box">
        ...
        <div class="form-inputs">
          ...
          <div class="form-submit">
            <sp-button type="primary" @click="submitForm"
              >{{ data.buttonName }}
            </sp-button>
          </div>
        </div>
    ...
    data: {
      ...
      default: () => {
        return {
          ...
          md: { form_name: '一键适配公司表单提交', track_code: 'SPTG000003' },
        }
      },
    },
  },
  ...
  methods: {
    ...
    formMaiDian() {
      window.sensors.track('p_formSubmitResult', {
        ...
        form_type: '咨询',
        form_name: this.data.md.form_name,
        track_code: this.data.md.track_code,
      })
    },
  },
  head() {
