...
export default {
      ...
      commentlist: [
        {
          ...
          date: ' 2020.10.06',
          tit:
            '需要办好几个业务，其中有个营业执照比较急，找了一些其他的公司咨询，要么不能在规定时间办理，要么价格贵太多，对比了以后最终选择在薯片办理，当然也不失所望，办理速度快，在承诺时间内就拿到了执照了，其他几个业务也办下来了，性价比挺高的。',
          val: 100,
        },
        {
          phone: '175******69',
          ...
          date: ' 2020.11.16',
          tit:
            '办理的几项业务中，对比其他公司收费不算是高，也是明码标价，关键是服务很细致没有其他的担忧，而且过程中没有任何要求额外加价的情况，省时省精力还有质量保证，其实折算下来比那些号称低价的花费更少，总之性价比很高。',
          val: 100,
        },
        {
          phone: '134******98',
          ...
          date: ' 2020.11.07',
          tit:
            '最初了解到薯片是在电梯里面，看到工商注册的广告，正好那段时间想出来创业，对注册公司不太了解，就找到薯片咨询了一下，注册公司流程繁琐。觉得还是交给代理公司去做，合作很愉快，同时也把公司其他业务交给了薯片来做，非常满意。',
          val: 100,
        },
        {
          phone: '137******49',
          ...
          date: '2020.11.29',
          tit:
            '出来创业，太多繁琐的事情不想自己搞，打算找代理公司去做，期间也比较过其他几家公司，最终决定选择薯片，也是看到薯片公司规模大，服务的人员多，最后顺利把公司办下来，刚开始做，考虑人员成本，也把公司的会计部分交给了顶呱呱来做，合作很愉快。',
          val: 100,
        },
        {
          phone: '168******86',
          ...
          date: '2020.12.12',
          tit:
            '薯片的店面很大，装修也不错，办理业务的业务人员也比较专业，他们的业务覆盖面广，种类架构也齐全，作为一家大公司，价格也是比较合理，总体来说性价比不错，当时办理的公司注册，整个服务还是感觉物超所值的。',
          val: 100,
        },
        {
          phone: '169******82',
          ...
          date: '2020.12.27',
          tit:
            '最开始只是来办理公司注册，没想到薯片提供的服务项目还挺多，大部分都是针对企业的，像我们这种规模不大的企业，简直太好了，公司注册找了他们，后面商标注册也找的薯片，现在已经将会计部分也交给了薯片，节省了不少成本。',
          val: 100,
        },
        {
          phone: '147******21',
          ...
          date: '2020.12.23',
          tit:
            '当时想注册一个商标，对商标注册流程不清楚，就打算找找能不能找人代注册，在网上找了一下，发现薯片集团还挺大的，心想这麽大的公司，应该可以信赖吧，比较其他几家公司，价格都差不多，最终还是选择了薯片，觉得放心。',
          val: 100,
        },
        {
          phone: '159******65',
          ...
          date: '2020.12.04',
          tit:
            '我当时办理的是营业执照，办理的速度艇快的，我的执照是15天就拿下来了，选择薯片是因为他们公司给我的服务体验很好，工作人员态度好，业务水平好，公司规模大。薯片的业务流程非常规范，种类也齐全，不夸张的说关于公司的所有业务他们都能办理，值得推荐。',
          val: 100,
        },
        {
          phone: '153******34',
          ...
          date: '2021.02.04',
          tit:
            '朋友推荐的，说是大平台做一站式企业服务的，抱着怀疑的态度来看看，果然是大平台服务态度杠杠的。',
          val: 100,
        },
        {
          phone: '132******54',
        ...
        },
        {
          ...
          date: '2021.03.26',
          tit:
            '推荐哦，薯片作为领跑企业的一站式企业服务平台，有良好的行业地位，算正规的大平台，办理业务也比较放心。',
          val: 100,
        },
        {
          phone: '154******57',
          ...
          date: '2021.04.01',
          tit:
            '听说累计至今，已经服务了百余万家企业，与15000多家大中型企业签署了长期合作协议。大家都说好才是真的好。',
          val: 100,
        },
        {
          phone: '175******75',
        ...
        },
        {
          ...
          date: '2020.05.21',
          tit:
            '之前在地铁还有网上看到过好几次新闻报道，好评如潮，相信在各界媒体的关注和监督下，平台会越做越好。',
          val: 100,
        },
        {
          phone: '143******79',
          ...
          date: '2020.07.28',
          tit:
            '大平台就是大平台，没有隐形消费，价格透明。以后有需要还是会选择在薯片办理。',
          val: 100,
        },
        {
          phone: '165******13',
          ...
          date: '2020.07.25',
          tit:
            '以前办理业务的时候需要自己亲自去办理，又浪费时间又麻烦，现在有了薯片省时省事多了。',
          val: 100,
        },
        {
          phone: '187******34',
          ...
          date: '2020.08.09',
          tit:
            '以前办理一个简单的业务也要3天左右才能下来，结果在薯片办理1天就搞定了，节省了我很多时间，果然懒人使社会进步。',
          val: 100,
        },
        {
          phone: '157******29',
          ...
          date: '2020.09.26',
          tit:
            '自从有了薯片这个平台，随时办理企业相关服务，方便多了。再也不用为了各种小事打电话，给我节约了很多时间。还能查看流程进度，非常开心能用到这么实用的app，希望能继续进步，加油！',
          val: 100,
        },
        {
          phone: '150******43',
          ...
          date: '2020.09.03',
          tit:
            '在薯片办理的企业服务，每每发现有问题联系到办事人员，办事人员都能抉速响应解决，服务非常满意。',
          val: 100,
        },
        {
          phone: '189******18',
          ...
          date: '2020.10.05',
          tit:
            '当我遇到问题顾问非常耐心的解答了我的问题，有什么意见也是及时处理了的，而且办事人员每个步骤都通知到位，资料都整理的很好，我是很满意的。',
          val: 100,
        },
      ],
      commentdata: [],
  ...
  created() {
    for (let i = 0; i < 3; i++) {
      const val = this.commentlist[
        Math.floor(Math.random() * this.commentlist.length)
      ]
