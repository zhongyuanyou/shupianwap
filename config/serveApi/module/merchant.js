 ...
 * @LastEditTime: 2020-12-24 15:36:14
...
module.exports.merchantApi = {
  ...
  tagList: '/yk/merchant/mch_user_business_category/v1/get_some_user_business.do', // 查询用户授权标签
  ...
  getAvatarIds: '/yk/common/v1/get_file_keys.do', // 获取入驻商户的头像ids方便去oss获取地址
};
