...
const evaluateApi = {
  ...
  addReview: `${CHIPS_WAP_BASE_URL}/yk/evaluate/v1/add_review_or_reply.do`, // 追评
  reviewFileId: `${CHIPS_WAP_BASE_URL}/yk/evaluate/v1/get_review_reply_file_id.do`, // 追评fileId
