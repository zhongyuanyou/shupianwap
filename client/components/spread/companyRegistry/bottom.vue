<template>
  <div class="bottom">
    ...
    <sp-bottombar safe-area-inset-bottom :fixed="true">
...
<script>
import { Bottombar, BottombarInfo, BottombarButton } from '@chipspc/vant-dgg'
export default {
  name: 'Bottom',
  components: {
